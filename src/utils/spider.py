...
search_query = '小车'  # 检索的关键词，可自行更改
location_driver = '/home/lxy/SoftWare/cdriver/chromedriver'  # Chrome驱动程序在电脑中的位置
...
class Crawler:
    ...
    def downloadImg(self, driver):
        ...
        foldername = search_query  # 定义文件夹的名字
        picpath = '/data/detect/%s' % (foldername)  # 下载到的本地目录
        # 路径不存在时创建一个
        ...
        pos = 0
        for i in range(50):  # 此处可自己设置爬取范围，本处设置为1，那么不会有下滑出现
            pos += 500  # 每次下滚500
